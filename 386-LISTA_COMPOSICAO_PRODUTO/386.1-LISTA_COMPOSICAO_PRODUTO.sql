SELECT DISTINCT
  ...
  CUS.ENTRADASEMICMS AS VALOR_SEM_ICMS,
  CUS.ENTRADACOMICMS AS VALOR_COM_ICMS
FROM TPRIPROC OPE
...
INNER JOIN (
    ...
    LEFT JOIN (
        SELECT 
            CODPROD, ENTRADASEMICMS, ENTRADACOMICMS
        FROM (
            SELECT 
        ...
        WHERE RN = 1
    ) CUS ON TAB.CODPRODMP = CUS.CODPROD
...
GROUP BY TAB.CODPRODMP, TAB.DESCRPROD, TAB.CODVOL, TAB.USOPROD, TAB.TIPOUSOMP, TAB.CODPRODPA, PRC.VERSAO, TAB.QTDMISTURA,PRO2.DESCRPROD,PRO2.CODGRUPOPROD,GRU2.DESCRGRUPOPROD,TAB.DHCAD,TAB.CODGRUPOPROD,TAB.DESCRGRUPOPROD,CUS.ENTRADASEMICMS,CUS.ENTRADACOMICMS
